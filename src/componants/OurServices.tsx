...
const OurServices = () => {
  return (
    <div className="grid lg:grid-cols-3 mx-10 p-5 gap-5 ">
      ...
      <div className="shadow-lg relative p-5 group cursor-pointer rounded flex flex-col items-center gap-2 overflow-hidden  ">
        ...
        <p className="text-sm indent-2 text-justify">
          ...
          service targets passive candidates with the exact skills your company
          needs. We handpick professionals from our global network and deliver
          curated shortlists.
        </p>
      ...
      <div className="shadow-lg relative p-5 group cursor-pointer rounded flex flex-col items-center gap-2 overflow-hidden  ">
        ...
        <p className="text-sm indent-2 text-justify">
          ...
          various domains (web, mobile, AI, blockchain, and more). Our advanced
          matching algorithm and expert vetting process ensure you hire the best
      ...
      <div className="shadow-lg relative p-5 group cursor-pointer rounded flex flex-col items-center gap-2 overflow-hidden  ">
        ...
        <h1 className="font-bold text-xl">Employer Branding & Job Promotion</h1>
        <p className="text-sm indent-2 text-justify">
          ...
          platform, social media, and developer communities to attract the right
          candidates.
        </p>
